...
void ContextDefaultState::handleMousePress(sf::Vector2f mousePos,
...
void ContextDefaultState::handleMouseMove(sf::Vector2f mousePos,
                                          CanvasController &controller,
                                          UIContext &context) {
...
void ContextDefaultState::handleMouseRelease(sf::Vector2f mousePos,
                                             CanvasController &controller,
                                             UIContext &context) {
  context.setDragAttempted(false);
}

void ContextDefaultState::handleKeyPress(sf::Keyboard::Key key,
                                         CanvasController &controller,
...
void ContextDefaultState::handleTextInput(char, StatusView &, UIContext &) {}
